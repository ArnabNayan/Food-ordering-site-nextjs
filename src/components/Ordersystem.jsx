...
const Ordersystem = () => {
    return (
        <div className='bg-fuchsia-50 '>
            <h1  data-aos="zoom-in"duration="1000" className=' text-yellow-500  text-2xl md:text-5xl text-center font-bold py-4'>How Will You Order?</h1> 
            <p  data-aos="zoom-in"duration="2000" className='text-slate-500 text-lg font-medium text-center'>Order Your Favourite Food and Enjoy Your Day With Our Nice And Tasty Food</p>
            <div  data-aos="fade-up"duration="3000" className='flex flex-col md:flex-row md:justify-between py-5 mx-5'>
                <div>
