...
const Popular = () => {
    return (
       <div className='  bg-black md:bg-[url("/offerBg.png")] '>
        <h1 data-aos="zoom-in"duration="1000" className=' text-yellow-500  text-2xl md:text-5xl text-center font-bold py-4'>Popular Collection</h1>
        <div data-aos="fade-up"duration="3000" className='flex flex-col md:flex-row items-center justify-center p-8 gap-4'>
  ...
  <div className="card-body mx-auto">
    <h2  data-aos="zoom-in"duration="2000" className="card-title text-yellow-500 text-3xl font-bold ">Pizza</h2>
...
<div className="card w-72 bg-black shadow-xl ">
  ...
  <div className="card-body mx-auto">
    <h2  data-aos="zoom-in"duration="2000" className="card-title text-yellow-500 text-3xl font-bold">Burger</h2>
...
<div className="card w-72 bg-black shadow-xl">
  ...
  <div className="card-body mx-auto">
    <h2  data-aos="zoom-in"duration="2000" className="card-title text-yellow-500 text-3xl font-bold">Egg Burger</h2>
...
<div className="card w-72 bg-black shadow-xl">
  ...
  <div className="card-body mx-auto">
    <h2  data-aos="zoom-in"duration="2000" className="card-title text-yellow-500 text-3xl font-bold">Pasta</h2>
